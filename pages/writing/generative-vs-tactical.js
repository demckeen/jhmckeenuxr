      ...
      <div className="blog container">
        <div className="blog">
          ...
          <div className="content">
            ...
            <p>As a UX Researcher, it really helps for me to have this shared understanding with my stakeholders because <strong>it makes cooperative communication a lot easier.</strong> I have a google document that I like to share with people, I call it my &ldquo;<a href="/writing/henrys-manual" target="_blank" rel="_noreferrer" className='in-text-link'>user&apos;s manual</a>&rdquo; - as in, it&apos;s a guide for how to get the BEST work out of me when we are working together. One of the first things we tell people is that a good way to get the ball rolling is to speak to what problem you are trying to solve for the user, and what questions would be helpful to answer in terms of making it easier for us to solve that problem?</p>
            <p>
            ...
            <p>Sometimes people refer to &ldquo;tactical&rdquo; research by other names like &ldquo;evaluative&rdquo; or &ldquo;experimental.&rdquo; Any of these terms are acceptable. At their core, they are all speaking to the idea that <strong>this type of research is getting at some form of measurable reaction to a stimulus that we (the TESTERS) are controlling.</strong> We have prototypes or mocks for them to react towards. We have survey questions for them to react to. We have distinct conditions for participants to be exposed to and provide a reaction towards, etc.</p>
            <p>
            It is, at the end of the day, a more simple <strong>stimulus-response form of data collection.</strong>  It is grounded in something concrete or tangible/perceivable by the participants. Are you more or less likely to click when it looks like &ldquo;this&rdquo; or when it looks like &ldquo;that&rdquo;? Why? When given this pile of &ldquo;items&rdquo; and you are instructed to sort them into groups (however it makes sense to you - open card sort), how are you going to do it? Why? etc. Their responses will be used to increase our confidence as <strong>we shape the tactics of the product&apos;s user experience.</strong>
            </p>
            <p className="section-title">Generative Research</p>
            <p>Sometimes people refer to &ldquo;generative&rdquo; research by other names like &ldquo;exploratory&rdquo;, &ldquo;formative&rdquo;, or &ldquo;foundational.&rdquo; All of these terms are acceptable, I simply prefer generative because it speaks to this research focusing on participants <strong>creating responses either in the absence of a concrete stimulus or they may be asked to specify or demonstrate a concrete stimulus</strong> as a part of the data collection process. The goal is for a stimulus to be <strong>GENERATED from the participant&apos;s responses to CONCEPTUAL or abstract questions.</strong></p>
            <ul className="questions-list">
                <li>&ldquo;What does it mean to do your job?&rdquo;</li>
                <li>&ldquo;Who are you interacting with in that capacity? How do those interactions typically go? Can you show me?&rdquo;</li> 
                <li>&ldquo;What tools are you utilizing in that capacity? What is it like, using those tools? Can you show me?&rdquo;</li>
                <li>&ldquo;What does it mean for your work to be completed successfully? What does that most desirable end-state look like? When that most desirable end-state doesn&apos;t happen, what causes it not to happen? What improvements can be made to these experiences that will increase the likelihood of that most desirable end-state?&rdquo;</li> 
            </ul>
            ...
            <ul className='questions-list'>
                <li>&ldquo;This condition was greatly preferred over that condition.&rdquo;</li>
                <li>&ldquo;This condition led to increased conversion numbers.&rdquo;</li>
            </ul>  
            ...
            <p>
            This is not a perfect world. Sometimes because of insufficient resources, we are forced to &ldquo;respond creatively&rdquo; to demanding circumstances. Perhaps we have generative questions, but no time or capacity to actually answer them. <strong>You can &ldquo;tactify&rdquo; a generative question by creating a hypothetical stimulus for participants to respond to.</strong> &ldquo;We don&apos;t really KNOW how people think about this kind of information, and how that shapes the best possible way for it to be organized… but if they DID think about it this hypothesized way… they would most likely respond positively to THIS hypothesized stimulus.&rdquo;
            </p>
