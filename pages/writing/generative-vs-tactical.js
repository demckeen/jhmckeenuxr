      ...
      <div className="blog container">
        <div className="blog">
          ...
          <div className="content">
            ...
            <p>As a UX Researcher, it really helps for me to have this shared understanding with my stakeholders because <strong>it makes cooperative communication a lot easier.</strong> I have a google document that I like to share with people, I call it my <a href="/writing/henrys-manual" target="_blank" rel="_noreferrer">&ldquo;user&apos;s manual&rdquo;</a> - as in, it&apos;s a guide for how to get the BEST work out of me when we are working together. One of the first things we tell people is that a good way to get the ball rolling is to speak to what problem you are trying to solve for the user, and what questions would be helpful to answer in terms of making it easier for us to solve that problem?</p>
            <p>
